...
class Usuarios extends CI_Controller
{
    ...
    public function store()
    {
        ...
        $this->form_validation->set_rules('dni', 'DNI', 'trim|required|exact_length[9]|is_unique[usuarios.dni]', array('required' => 'Debes proporcionar un %s.', 'is_unique' => 'Este %s ya existe', 'exact_length' => 'El %s debe ser 9 digitos'));
    ...
    public function update()
    {
        ...
        $this->form_validation->set_rules('nombres', 'Nombres', 'trim|required', array('required' => 'Debes proporcionar un %s.'));
        $this->form_validation->set_rules('apellidos', 'Apellidos', 'trim|required', array('required' => 'Debes proporcionar un %s.'));
        $this->form_validation->set_rules('dni', 'DNI', 'trim|required|exact_length[9]' . $is_unique_dni, array('required' => 'Debes proporcionar un %s.', 'is_unique' => 'Este %s ya existe', 'exact_length' => 'El %s debe ser 9 digitos'));
