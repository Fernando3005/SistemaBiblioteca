...
<div class="wrapper">
	...
	<header class="main-header">
		...
		<a href="<?php echo base_url(); ?>backend/dashboard" class="logo">
			...
			<span class="logo-lg"><b>UniBin</b></span>
		</a>
	...
	<div class="content-wrapper">
		...
		<section class="content-header">
			...
			<ol class="breadcrumb">
				<li><a href="<?php echo base_url(); ?>backend/dashboard"><i class="fa fa-dashboard"></i> INICIO</a></li>
	...
	<footer class="main-footer">
		...
		<strong>Copyright &copy; 2020-2021 <a href="https://www.universidadbinacional.mx/">Universidad Binacional</a>.</strong> Oscar Valenzuela
	</footer>
