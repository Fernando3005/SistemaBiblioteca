...
<head>
    ...
    <title>UniBin - <?php echo $title; ?></title>
...
<body>
                        ...
                        <tbody>
                            ...
                            <?php foreach ($libros as $libro): ?>
                                <tr>
                                    ...
                                    <td><button type="button" class="btn btn-warning btn-sm btn-select" value="<?php echo $libro->id_libro ?>" data-toggle="modal" data-target="#myModal2" > Solicitar</button></td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
          ...
          <form class="form-horizontal" id="form-prestamo" role="form">
          <div class="modal-body">

                <div class="form-group">
                    <label class="col-sm-3 control-label" for="dni" >Nombres :</label>
                    <div class="col-sm-4">
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label" for="dni" >Apellidos :</label>
                    <div class="col-sm-4">
                        <input type="hidden" name="idLector">
                        <input type="text" class="form-control" id="dni" placeholder="dni" required/>
                    </div>
